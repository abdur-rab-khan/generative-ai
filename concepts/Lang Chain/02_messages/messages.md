...
- [Table of Contents](#table-of-contents)
  ...
  - [LangChain Message](#langchain-message)
    - [1. SystemMessage](#1-systemmessage)
    - [2. HumanMessage](#2-humanmessage)
    - [3. AIMessage](#3-aimessage)
    - [4. AIMessageChunk](#4-aimessagechunk)
    - [5. ToolMessage](#5-toolmessage)
    - [6. RemoveMessage](#6-removemessage)
...
- So message have following information
    ...
    3. Additional metadata: metadata:id, token usage and other model-specific data.
